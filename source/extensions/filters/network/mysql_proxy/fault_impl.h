...
public:
  FaultManagerImpl(Random::RandomGenerator& random, Runtime::Loader& runtime,
                   const Protobuf::RepeatedPtrField<
                       ::envoy::extensions::filters::network::mysql_proxy::v3::MySQLProxy::Fault>
                       base_faults);
...
private:
  ...
  public:
    FaultImpl(envoy::extensions::filters::network::mysql_proxy::v3::MySQLProxy::Fault base_fault);
  ...
  private:
    static std::vector<std::string> buildCommands(
        envoy::extensions::filters::network::mysql_proxy::v3::MySQLProxy::Fault base_fault);
