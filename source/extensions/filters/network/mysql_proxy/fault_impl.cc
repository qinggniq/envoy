...
FaultManagerImpl::FaultImpl::FaultImpl(
  ...
  case envoy::extensions::filters::network::mysql_proxy::v3::MySQLProxy::Fault::DELAY:
    fault_type_ = FaultType::Delay;
    break;
  case envoy::extensions::filters::network::mysql_proxy::v3::MySQLProxy::Fault::ERROR:
